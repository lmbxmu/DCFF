...
class FusedInception(nn.Module):
    def __init__(self, in_planes, n1x1, n3x3red, n3x3, n5x5red, n5x5, pool_planes, flayer_cprate, cur_fconvid):
        ...
        self.b1 = nn.Sequential(
            FuseConv2d(in_channels=last_cout, out_channels=n1x1, kernel_size=1, real_cout=cur_cout),
        ...
        self.b2 = nn.Sequential(
            FuseConv2d(in_channels=last_cout0, out_channels=n3x3red, kernel_size=1, real_cout=cur_cout0),
            nn.BatchNorm2d(cur_cout0),
            nn.ReLU(True),
            FuseConv2d(in_channels=last_cout1, out_channels=n3x3, kernel_size=3, padding=1, real_cout=cur_cout1),
        ...
        self.b3 = nn.Sequential(
            FuseConv2d(in_channels=last_cout0, out_channels=n5x5red, kernel_size=1, real_cout=cur_cout0),
            nn.BatchNorm2d(cur_cout0),
            nn.ReLU(True),
            FuseConv2d(in_channels=last_cout1, out_channels=n5x5, kernel_size=3, padding=1, real_cout=cur_cout1),
            nn.BatchNorm2d(cur_cout1),
            nn.ReLU(True),
            FuseConv2d(in_channels=last_cout2, out_channels=n5x5, kernel_size=3, padding=1, real_cout=cur_cout2),
        ...
        self.b4 = nn.Sequential(
            ...
            FuseConv2d(in_channels=last_cout, out_channels=pool_planes, kernel_size=1, real_cout=cur_cout),
            nn.BatchNorm2d(cur_cout),
            nn.ReLU(True),
        )
...
class FusedGoogLeNet(nn.Module):
    def __init__(self, flayer_cprate):
        ...
        self.pre_layers = nn.Sequential(
            FuseConv2d(in_channels=last_stage_cout, out_channels=192, kernel_size=3, padding=1, real_cout=cur_stage_cout),
